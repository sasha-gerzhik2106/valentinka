...
const quizQuestions = [ // Массив вопросов для третьего шага
    ...
    },
    {
        ...
        options: ["Март", "Июнь", "Декабрь", "Январь"],
        correctAnswer: "Декабрь"
    },
    {
        question: "Где было наше самое веселое приключение?",
        options: ["У меня в лесу", "После кино в ривьере", "В парке Шевченко", "Прогулка зимой возле книжки"],
        correctAnswer: "После кино в ривьере"
    }
];

const valentinText = "Эта валентинка для моей самoй большой любви! Продолжай так же ярко сиять и делать мою жизнь ярче! Спасибо что ты у меня есть. Я ЛЮБЛЮ ТЕБЯ БОЛЬШЕ ВСЕГО В ЭТОМ МИРЕ!" // Текст для финального шага
